if ( 'OVER' != getCookie("FIRSTTIME") ) {
	setCookie("_I", "https://impressionyang.gitee.io/");
	setCookie("_G", "https://www.google.com/");	
    setCookie("_1", "https://www.typing.com/student/lessons");
	setCookie("_A", "http://www.alloyteam.com/nav/");
	setCookie("_B", "https://www.baidu.com/");
    setCookie("_M", "https://www.marxists.org/chinese/");
    setCookie("_L", "https://betterrong.cn");
    setCookie("_I_F", "https://impressionyang.gitee.io/imgbed/img/avatar/logo_typhone.svg");
    setCookie("_T_F", "https://www.typing.com/dist/shared/images/favicons/typing/favicon.ico");
    // setCookie("_A_F", "http://www.alloyteam.com/nav/static/images/alloyteam-favicon.jpg");
